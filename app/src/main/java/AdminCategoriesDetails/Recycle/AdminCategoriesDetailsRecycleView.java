package AdminCategoriesDetails.Recycle;
...
public class AdminCategoriesDetailsRecycleView extends RecyclerView.Adapter<MyViewHolder> {

    LayoutInflater layoutInflater;
    Context context;
    List<SubCategory> subCatCollection;
    AdminCategoriesDetailsFragment adminCategoriesDetailsFragment;

    public AdminCategoriesDetailsRecycleView(Context context , List<SubCategory> subCatCollection, AdminCategoriesDetailsFragment myfragment ) {
        layoutInflater = LayoutInflater.from(context);
        this.context = context;
        this.subCatCollection = subCatCollection;
        this.adminCategoriesDetailsFragment = myfragment;
     }
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        holder.textView.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View view) {
                ...
                adminCategoriesDetailsFragment.Delete(subCategory);
                return true;
            }
        });
    }
